      ...
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
        ...
        >
          <div className="w-full min-h-full">
            ...
            {currentPage === "login" && (
              <LoginPage onGoogleLogin={() => (window.location.href = "http://localhost:5000/auth/google")} onLoginSuccess={fetchUserProfile} onGoToSignup={() => goTo("signup")} onBackToHome={() => goTo("landing")} />
            )}

            {currentPage === "signup" && (
              <SignupPage onGoogleSignup={() => (window.location.href = "http://localhost:5000/auth/google")} onSignupSuccess={() => setPageStack(["onboarding"])} onGoToLogin={() => goTo("login")} onBackToHome={() => goTo("landing")} />
            )}
