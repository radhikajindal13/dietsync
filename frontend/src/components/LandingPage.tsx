import { Leaf, Clock, ShoppingCart, ChefHat, Heart, Shield, Sparkles } from 'lucide-react';
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-green-700">DietSync</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-xl">
              AI-powered meal recommendations tailored to your health needs. Practical recipes, 
              clear nutrition breakdowns, and grocery-ready plans — built with trusted USDA data.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="flex items-center gap-2 px-6 py-3 border border-gray-300 rounded-lg hover:border-green-600 hover:bg-green-50 transition-all">
